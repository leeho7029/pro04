...
<section class="section" id="location">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title mb-4 font-weight-bold">오시는 길</h2>
        </div>

        <div class="row justify-content-center">
            <div class="col-md-8">
                <div id="map" class="mb-4" style="width: 100%; height: 400px; background: white;"></div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6">
                <h4 class="mb-3"><i class="fa-solid fa-location-dot"></i> 주소</h4>
                <p>서울 금천구 디지털로9길 23 마리오아울렛2관</p>

                <h4 class="mb-3"><i class="fa-solid fa-mobile"></i> Tel</h4>
                <p>011-234-3515</p>
            </div>
            <div class="col-md-6">
                <h4 class="mb-3"><i class="fa-solid fa-fax"></i> Fax</h4>
                <p>02-1111-111</p>
            </div>
        </div>
    </div>
