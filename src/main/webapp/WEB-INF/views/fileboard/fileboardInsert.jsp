...
<!-- 자료실 글쓰기 시작 --><section class="section">
    <div class="container">
                    ...
                    <form action="${path}/fileboard/insert.do" id="writeform" method="post" enctype="multipart/form-data">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" id="title" name="title" placeholder="제목을 입력해주세요" autocomplete="off" autofocus required>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="content">내용</label>
                                <textarea name="content" id="content" class="form-control" rows="5" placeholder="내용을 입력해주세요" required></textarea>
                            </div>
