                ...
                <div class="has-background-white card-content shadow-down p-6">
                    ...
                    <div class="columns is-multiline is-centered">
                        <div class="column is-10-tablet">
                            ...
                            <div class="control">
                                <input type="text" class="input" name="id" id="id" size="100" class="input" value="${user.id }" readonly>
                            </div>
                        </div>
                        <div class="column is-10-tablet">
                            <label for="name" class="label"> 이름 </label>
                            <div class="control">
                                <input type="text" class="input" name="name" id="name" class="input"  value="${user.name }" readonly>
                            </div>
                        </div>
                        <div class="column is-10-tablet">
                            <label for="email" class="label"> 이메일 </label>
                            <div class="control">
                                <input type="email" name="email" id="email" class="input" value="${user.email }" readonly>
                            </div>
                        </div>
                        <div class="column is-10-tablet">
                            <label for="tel" class="label"> 전화번호 </label>
                            <div class="control">
                                <input type="tel" class="input" name="tel" id="tel" class="input"  value="${user.tel }" readonly>
                            </div>
                        </div>
                        <div class="column is-10-tablet">
                            <label for="tel" class="label"> 주소 </label>
                            <div class="control">
                                <input type="text" name="addr1" id="addr1" class="input" value="${user.addr1 }" readonly>
                                <input type="text" name="addr2" id="addr2" class="input mt-3" value="${user.addr2 }" readonly>
                                <input type="text" name="addr2" id="postcode" class="input mt-3" value="${user.postcode }" readonly>
                            </div>
                        </div>
                        <div class="column is-10-tablet">
