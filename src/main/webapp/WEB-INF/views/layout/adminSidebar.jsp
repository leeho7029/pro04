...
<ul class="navbar-nav bg-gradient-light sidebar sidebar-white accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="${path}/" style="background-color: lightgray;">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-gray py-2 collapse-inner rounded">
                ...
                <a style="color: black" class="collapse-item" href="${path}/admin/lectureMgmt"> 강의목록 </a>
                <a style="color: black" class="collapse-item" href="${path}/admin/lectureInsert"> 강의등록 </a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseThree" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-gray py-2 collapse-inner rounded">
                ...
                <a style="color: black" class="collapse-item" href="${path}/admin/teacherMgmt"> 강사목록 </a>
                <a style="color: black" class="collapse-item" href="${path}/admin/teacherInsert"> 강사등록 </a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapsesix" class="collapse" aria-labelledby="headingsix" data-parent="#accordionSidebar">
            <div class="bg-gray  py-2 collapse-inner rounded">
                ...
                <a style="color: black"  class="collapse-item" href="${path}/admin/deliveryMgmt"> 배송 관리 </a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseseven" class="collapse" aria-labelledby="headingseven" data-parent="#accordionSidebar">
            <div class="bg-gray  py-2 collapse-inner rounded">
                ...
                <a style="color: black"  class="collapse-item" href="${path}/admin/bookMgmt"> 교재 관리 </a>
                <a style="color: black"  class="collapse-item" href="${path}/admin/bookInsert"> 교재 등록 </a>
            </div>
        </div>
    </li>
