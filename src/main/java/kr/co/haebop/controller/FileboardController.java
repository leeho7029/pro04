...
public class FileboardController {
    ...
    public String write(Fileboard fileboard, @RequestParam("upfile") MultipartFile[] files, Model model, HttpServletRequest req) throws IllegalStateException, IOException {
        ...
        if (id != null && id.equals("admin")) { //관리자만 등록가능
            ...
            fileboard.setFileInfos(fileInfos);
            fileboard.setId(id);
            try {
                fileboardService.writeArticle(fileboard);
