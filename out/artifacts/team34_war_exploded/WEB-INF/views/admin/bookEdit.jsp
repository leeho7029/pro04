    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="container mt-100 mb-100">
                <h2> 교재 수정 <i class="fa-solid fa-book"></i> </h2>
                <form action="${path}/admin/bookEdit" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <input type="text" name="bname" id="bname" value="${book.bname}" class="form-control" autocomplete="off" required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="author"> 저자 </label>
                        <input type="text" name="author" id="author" value="${book.author}" class="form-control" autocomplete="off" required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="bprice"> 가격 </label>
                        <input type="number" name="bprice" id="bprice" value="${book.bprice }" class="form-control" autocomplete="off" required>
                    </div>
                    <div class="form-group mt-3">
                        <label for="content"> 교재 소개 </label>
                        <textarea name="content" id="content" value="${book.content}" class="form-control" cols="30" rows="10" maxlength="1400" required></textarea>
                    </div>
